...
const menuSections = [
  ...
  },
  {
    label: '投稿',
    items: [
      { href: '/daily-reports', label: 'デイリーレポート', icon: 'M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10l4 4v10a2 2 0 01-2 2zM14 4v4h4' },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/settings/search-themes', label: 'AI検索テーマ', icon: 'M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z' },
